...
klc_prefix_dummy = (
    '''KBD\t{}\t"{}"\r\rCOPYRIGHT\t"(c) {} {}"\r\rCOMPANY\t"{}"\r\r'''
    '''LOCALENAME\t"{}"\r\rLOCALEID\t"{}"\r\rVERSION\t1.0\r\rSHIFTSTATE\r\r'''
    '''0\t//Column 4\r1\t//Column 5 : Shft\r2\t//Column 6 :       Ctrl\r'''
    '''3\t//Column 7 : Shft  Ctrl\r6\t//Column 8 :       Ctrl Alt\r7\t'''
    '''//Column 9 : Shft  Ctrl Alt\r\rLAYOUT\t\t'''
    ''';an extra '@' at the end is a dead key\r\r'''
